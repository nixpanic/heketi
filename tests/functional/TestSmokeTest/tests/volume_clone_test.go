...
func TestCloneVolume(t *testing.T) {
	...
	tests.Assert(t, err == nil, "expected err == nil, got:", err)
	tests.Assert(t, vol.Id != clonedVol.Id, "expected vol.Id != clonedVol.Id, got:", err)
	...
	tests.Assert(t, err == nil, "expected err == nil, got:", err)
	tests.Assert(t, namedClonedVol.Name == cloneReq.Name, "expected namedClonedVol.Name == cloneReq.Name, got:", err)
}
